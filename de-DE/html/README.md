...
* Zwei weitere `article`-Elemente beinhalten unsere Blogposts mit jeweils einem Publikationsdatum in einem `time`-Element, einem `h2`-Element mit dem Titel des Posts und einem `p`-Element (Absatz, engl. "paragraph") mit dem Text unseres Blogposts.
