...
So far we've been writing all our python code in the interpreter, which limits us to entering one line of code at a time. برنامه های نرمال در فایل ذخیره می شوند و به وسیله **مفسر** یا **کامپایلر** زبان برنامه نویسی اجرا می شوند. تا اینجا ما برنامه هایمان به صورت - هربار، یک خط - در **مفسر** پایتون اجرا کردیم. برای تمرین های بعدی به بیش از یک خط کد نیاز خواهیم داشت، پس ما نیاز داریم تا سریعا:
