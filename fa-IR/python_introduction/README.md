...
نیازی نیست برای هر خط کد کامنت بنویسید، ولی آنها برای توضیح اینکه چرا کد شما کاری را انجام می دهد یا برای داشتن یک خلاصه زمانی که کار پیچیده ای را انجام می دهد، مفید اند.
