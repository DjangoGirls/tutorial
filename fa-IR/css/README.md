...
به همین ترتیب جلو بروید و برخی بخش‌های کد HTML را نام گذاری کنید. بخش `header` را که شامل header وب‌سایت شماست با کد زیر جابجا کنید:
...
و اکنون کلاس `post` را به `article` اضافه کنید که حاوی یک پست وبلاگ است.
