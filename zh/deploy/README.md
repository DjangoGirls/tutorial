...
如果你在访问你的网站时候看到一个错误，首先要去 **error log** 中找一些调试信息。 你可以在 PythonAnywhere [Web 选项卡][9] 中发现它的链接。 检查那里是否有任何错误信息，底部是最新的信息。 常见问题包括：
...
*   有一些常见的调试小贴士在 [general debugging tips on the PythonAnywhere wiki][10] 里.
