...
Վերջապես, մենք կարող ենք հստակեցնել, թե որ դաշտը (կամ դաշտերը) պետք է առկա լինեն մեր ֆորմայում: Այս սցենարում մենք ուզում ենք, որ բացահայտվի միայն ` title (վերնագիրը) ` և ` text(տեքստը) ` ` created_date(ստեղծված_ ամսաթիվը) ` պետք է ավտոմատ կերպով սահմանվի, երբ մենք ստեղծում ենք գրառում (այսինքն ՝ կոդում), այնպես չէ՞:
