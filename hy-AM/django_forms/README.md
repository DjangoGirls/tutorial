...
Վերջին բանը, որ մենք ուզում ենք անել մեր կայքում, բլոգի գրառումներն ավելացնելու և խմբագրելու հարմարավետ միջոց ստեղծելն է: Django- ի `admin` -ը (ադմինիստրատորը) հիանալի է, բայց դրա դիզայնը դժվար է փոխել: ` ձևերով ` մենք բացարձակ ուժ կունենանք մեր ինտերֆեյսի վրա. Մենք կարող ենք անել գրեթե այն ամենը, ինչ կարող ենք պատկերացնել:
