...
Եկեք ստեղծենք CSS ֆայլ ՝ ձեր վեբ էջում ձեր սեփական ոճը ստեղծելու համար: Ստեղծեք ` css ` անունով նոր գրացուցակ ձեր ` ստատիկ ` գրացուցակի ներսում: Դրանից հետո ստեղծեք ` blog.css ` կոչվող նոր ֆայլ այս ` css ` գրացուցակի ներսում: Պատրա՞ստ եք
