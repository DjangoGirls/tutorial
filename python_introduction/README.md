...
To start tinkering with Python, we need to open up a *prompt* on your computer. How you get there depends on the operating system you use, but once it's open, everything is pretty much the same.
