...
Note that if you are still in the same Bash console used previously in this tutorial, you don’t have to use the `cd` command as you would already be in that directory.
