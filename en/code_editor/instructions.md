...
The second reason is that code editors are specialized for editing code, so they can provide helpful features like syntax highlighting (highlighting code with color according to its meaning), or automatically closing quotes for you.
