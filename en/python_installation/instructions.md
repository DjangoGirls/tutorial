...
If you have a different version of Python installed, at least 3.4.0 (e.g. 3.6.0), then you don't have to upgrade. If you don't have Python installed or if you want a newer version, you could first check what Linux distribution you are using with the following command:
