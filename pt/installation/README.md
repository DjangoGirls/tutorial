...
* Sua oficina pode ter um "grupo de instalação" antes da oficina principal. Se você está com um grupo de instalação, essa página é para você! Siga as instruções aqui contidas para ter tudo que precisa instalar para a oficina, com a ajuda de instrutores, se necessário. Então, no workshop principal, poderá pular as instruções de instalação que encontrar no tutorial principal, sempre que aparecer.
