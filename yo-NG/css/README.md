...
Nínú fáìlì CSS kan, a máa pinnu àwọn àrà fún àwọn element nínú fáìlì HTML náà. Ọnà àkọ́kọ́ tí a lè fi mọ àwọn element ni pẹ̀lú orúkọ element náà. You might remember these as tags from the HTML section. Things like `a`, `h1`, and `body` are all examples of element names. We also identify elements by the attribute `class` or the attribute `id`. Class and id are names you give the element by yourself. Classes define groups of elements, and ids point to specific elements. For example, you could identify the following tag by using the tag name `a`, the class `external_link`, or the id `link_to_wiki_page`:
