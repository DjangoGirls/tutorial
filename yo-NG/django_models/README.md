...
Ní báyìí, a ó ṣàlàyé àwọn ohun ìdánimọ̀ tí a tí n sọ̀rọ̀ nípa: `title` (àkọlé), `text` (ọ̀rọ̀), `created_date` (ọjọ́ ṣíṣẹ̀dá), `published_date` (ọjọ́ títẹ̀jáde) and `author` (olùdásílẹ̀). Láti ṣe ìyẹn, a ní láti ṣàlàyé irú ààyè kọ̀ọ̀kan (Ṣé ọ̀rọ̀ ni? Nọ́mbà kan? A date? A relation to another object, like a User?)
