...
> **注**これは初心者向けのチュートリアルです。このサイトを展開する際には、セキュリティの観点からは理想的ではない、いくつかのショートカットを取り上げました。 このプロジェクトを構築するか、新しいプロジェクトを開始する場合は、あなたのサイトをセキュアにするための情報を得るのに[Djangoデプロイメント チェックリスト](https://docs.djangoproject.com/en/2.0/howto/deployment/checklist/)をご覧ください。
