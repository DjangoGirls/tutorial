...
Csak annyit kell tenned, hogy kiválasztasz egy könyvtárat, ahova a `virtualenv`et szeretnéd telepíteni, például a home könyvtárat. On Windows, it might look like `C:\Users\Name` (where `Name` is the name of your login).
...
Where `myvenv` is the name of your `virtualenv`. Bármi más nevet is használhatsz, de maradj a kisbetűs szavaknál, és ne használj szóközt, ékezeteket, vagy más speciális karaktereket. It is also a good idea to keep the name short – you'll be referencing it a lot!
...
A `myvenv` a`virtualenv`-ed neve. Más nevet is használhatsz, de maradj a kisbetűs szavaknál, és ne használj szóközt, ékezeteket, vagy más speciális karaktereket. It is also a good idea to keep the name short as you'll be referencing it a lot!
