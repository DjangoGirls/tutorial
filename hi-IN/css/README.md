...
Django पहले से ही जानता है कि अंत: निर्मित "admin" ऐप के लिए स्टेटिक फ़ाइलों को कहाँ खोजें। अब हमें अपने ऐप के लिए कुछ स्टेटिक फाइलों को जोड़ने की जरूरत है, `blog`।
