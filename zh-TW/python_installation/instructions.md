...
![別忘了將 Python 添加到路徑](../python_installation/images/python-installation-options.png)
...
你需要到這個網站 https://www.python.org/downloads/release/python-361/ 下載 Python 安裝檔:
...
If you have a different 'micro version' of Python installed, e.g. 3.6.0, then you don't have to upgrade. 如果你沒有已安裝的 Python 或是你的版本不一樣，你可以如下步驟來安裝：
...
If you have any doubts, or if something went wrong and you have no idea what to do next, please ask your coach! 請教一個經驗豐富的人有時可以讓事情更順利更完美！