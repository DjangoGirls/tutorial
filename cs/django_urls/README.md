...
Každá stránka na internetu potřebuje svou vlastní URL. This way your application knows what it should show to a user who opens that URL. V Djangu používáme takzvaný `URLconf` (URL konfigurace). URLconf is a set of patterns that Django will try to match with the requested URL to find the correct view.
