...
Після запуску консолі Python, як ми побачили, запрошення змінилось на `>>>`. Для нас це означає, що відтепер ми можемо користуватися лише командами мови Python. Вам не доведеться друкувати `>>>`, Python зробить це для вас сам.
...
- **консоль** – виконання команд (коду) в консолі Python одразу показує їхній результат
