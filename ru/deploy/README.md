...
Код загружен на GitHub. Зайди на сайт и проверь! Вы найдете это в компании - [ Django][5], [ учебник ][6] и многие другие проекты c открытым исходным кодом на GitHub :)
