...
{% filename %}command-line{% endfilename %}
    ...
    Переди на [GitHub.com](https://www.github.com) и зарегистрируй новый бесплатный аккаунт. (Если вы уже сделали это в мастерской prep, это здорово!) Затем создайте новый репозиторий, указав ему имя «my-first-blog». Оставьте чек-бокс "initialize with a README" неактивным, оставьте опцию .gitignore пустой (мы сделаем это вручную) и отметьте License как None.
