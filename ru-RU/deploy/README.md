...
> **Примечание** Если ты уже прошла шаги установки, не нужно делать это снова - можешь пропустить этот раздел и приступать к созданию Git репозитория.
...
Теперь твой сайт в публичном Интернете! Перейди во вкладку "Web" на PythonAnywhere, чтобы получить ссылку на твой сайт. Ты можешь поделиться ей с кем угодно. :)
