...
> **Примечание:** Это учебник для начинающих и при разворачивании сайта мы использовали несколько приёмов, которые не являются идеальными с точки зрения безопасности. Если и когда ты решишь достроить этот проект, или же начать новый, то необходимо будет просмотреть [Djangodeployment checklist](https://docs.djangoproject.com/en/2.0/howto/deployment/checklist/) для некоторых советов по безопасности твоего сайта.
