...
สำหรับตอนนี้ เรายังไม่อยากออกจากคอนโซล Python เราต้องการจะเรียนรู้เพิ่มเติมเกี่ยวกับมัน เริ่มด้วย ของง่ายๆ ก่อน For example, try typing some math, like `2 + 3` and hit `enter`.
...
นอกจาก string และ ตัวเลข แล้ว Python ยังมีประเภทข้อมูลชนิดต่างๆ อยู่อีก ตอนนี้เราจะแนะนำให้รู้หนึ่งในนั้น คือ **list** Lists are exactly what you think they are: objects which are lists of other objects. :)
