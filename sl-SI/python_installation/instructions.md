...
![Ne pozabi dodati Pythona v Path](../python_installation/images/python-installation-options.png)
...
Pojdi na spletno stran https://www.python.org/downloads/release/python-361/ in nato:
...
If you have a different 'micro version' of Python installed, e.g. 3.6.0, then you don't have to upgrade. Če slučajno še ni nameščen, to narediš takole:
...
If you have any doubts, or if something went wrong and you have no idea what to do next, please ask your coach! Namestitev se včasih lahko zakomplicira zato je bolje, da za pomoč prosiš nekoga z več izkušnjami.