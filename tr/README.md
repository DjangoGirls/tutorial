...
Cascading Style Sheets (CSS) HTML gibi dilleri kullanarak hazırlanmış bir websitesini güzelleştirmek için kullanılan bir dildir. Yani, web sayfası için makyaj gibidir ;)
