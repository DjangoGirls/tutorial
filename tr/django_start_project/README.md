...
> 
> Parts of this chapter are based on the [django-marcador tutorial](http://django-marcador.keimlink.de/) licensed under the Creative Commons Attribution-ShareAlike 4.0 International License. Django-marcador tutorial'ının hakları Markus Zapke-Gründemann'e aittir.
...
> virtualenv içindeki her şeyi çalıştırmayı unutmayın. If you don't see a prefix `(myvenv)` in your console, you need to activate your virtualenv. **Django yükleme** bölümünün **virtualenv ile Çalışma** kısmında nasıl yapılacağını açıkladık. Typing `myvenv\Scripts\activate` on Windows or `source myvenv/bin/activate` on Mac OS X or Linux will do this for you.
...
Web sitemizin doğru bir saate sahip olması güzel olurdu. Go to [Wikipedia's list of time zones](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) and copy your relevant time zone (TZ) (e.g. `Europe/Berlin`).
