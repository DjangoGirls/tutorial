...
If you have a different 'micro version' of Python installed, e.g. 3.6.0, then you don't have to upgrade. Se non hai Python installato o se vuoi una versione diversa, puoi istallarla come segue:
